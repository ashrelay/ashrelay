...
```
I build things from the interface down to the database. I am not an expert. I am mostly just stubborn and reasonably decent at feeding highly specific instructions into a prompt box and duct taping stuff together. 
